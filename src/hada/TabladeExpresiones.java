...
public class TabladeExpresiones {
      ...
      // Definicion_multiples_variables_Correcta("([' ']{0,}[A-Z|a-z]{1,}[a-z|A-Z|0-9|_]*{0,}[a-z|A-Z|0-9]{1,}[,][' ']{0,}[A-Z|a-z]{1,}[a-z|A-Z|0-9|_]*{0,}[a-z|A-Z|0-9]{1,}){1,}([:]{1,})[' ']{0,}(INTEGER|FLOAT|float|CHARACTER)[' ']{0,}([;]{1})([' ']{0,})"),
...
//       Definicion_variables_Correcta_sola("[' ']{0,}[A-Z|a-z]{1,}[a-z|A-Z|0-9|_]*{0,}[a-z|A-Z|0-9]{1,}[' ']{0,}[:]{1,}[' ']{0,}(INTEGER|FLOAT|float|CHARACTER)[' ']{0,}([;]{1})([' ']{0,})"),
...
//       // una sola que no corresponde a nada
       ...
       //  Reservado( "{1,}[a-zA-Z|0-9|' ']{0,}[;]"),
        Etiqueta1("[' ']{0,}([\\<<])[' ']{0,}([A-Z|a-z]{1,}[a-z|A-Z|0-9|_]*{0,}[a-z|A-Z|0-9]{1,})[' ']{0,}([^\\>>]{1,}[' ']{0,})"),//SIN CIERRE
        Etiqueta_correcta("[' ']{0,}([<<]{1,})[' ']{0,}([A-Z|a-z]{1,}[a-z|A-Z|0-9|_]*{0,}[a-z|A-Z|0-9]{1,})[' ']{0,}([>>]{1,})[' ']{0,}"),
        Etiqueta2("[' ']{0,}([^\\<<])[' ']{0,}([A-Z|a-z]{1,}[a-z|A-Z|0-9|_]*{0,}[a-z|A-Z|0-9]{1,})[' ']{0,}([\\>>]{1,}[' ']{0,})"),// SIN APERTURA
