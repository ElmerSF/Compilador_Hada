...
//        Inicio6("([' ']{0,})((PROCEDURE|procedure|Procedure)[' ']{0,}([0-9]{1,20}.{0,20})[' ']{0,}(IS|is|Is))"),
       ...
       Definicion_variables7("[' ']{0,}[A-Z|a-z]{1,}[a-z|A-Z|0-9|_]*{0,}[a-z|A-Z|0-9]{1,}[' ']{0,}[:]{2,}[' ']{0,}[a-z|A-Z]*{0,}[' ']{0,}[;]{0,}[' ']{0,}"),
       Definicion_variables8("[' ']{0,}[A-Z|a-z]{1,}[a-z|A-Z|0-9|_]*{0,}[a-z|A-Z|0-9]{1,}[' ']{0,}[=]{1,}[' ']{0,}[a-z|A-Z]*{0,}[' ']{0,}[;]{0,}[' ']{0,}"),
       Definicion_variables9("[' ']{0,}[A-Z|a-z]{1,}[a-z|A-Z|0-9|_]*{0,}[a-z|A-Z|0-9]{1,}[' ']{0,}[:]{1,}[' ']{0,}[a-z|A-Z]*{0,}[' ']{0,}"),
       Definicion_variables10("[' ']{0,}[A-Z|a-z]{1,}[a-z|A-Z|0-9|_]*{0,}[a-z|A-Z|0-9]{1,}[' ']{0,}[:]{1,}[' ']{0,}[a-z|A-Z]*{0,}[' ']{0,}[;]{0,}[' ']{0,}"),
