...
public class TabladeExpresiones {
    ...
    public enum Tipos {
        ...
        Nombre_Arhivo_caracter("[' ']{0,}[!|#|$|@|%|&]{1,}[a-z|A-Z|0-9|_]*{0,}[a-z|A-Z|0-9]{1,}[' ']{0,}[:]{1,}[' ']{0,}[A-Z|a-z]{0,}[' ']{0,}[;]{0,}[' ']{0,}"),
        ...
        Definicion_variables2("[,](FACTOR1)[,](FACTOR2)[,](FACTOR3)[:](FLOAT)[;]"),//("[' ']{0,}[,]{1,}[' ']{0,}[[A-Z|a-z]{1,}[a-z|A-Z|0-9|_]*{0,}[a-z|A-Z|0-9]{1,}]{1,}[,]{1,}[' ']{0,}[[A-Z|a-z]{1,}[a-z|A-Z|0-9|_]*{0,}[a-z|A-Z|0-9]{1,}]{1,}[[,]{1,}[' ']{0,}[[A-Z|a-z]{1,}[a-z|A-Z|0-9|_]*{0,}[a-z|A-Z|0-9]{1,}]]{0,}[' ']{0,}[:][' ']{0,}(INTEGER|FLOAT|float|CHARACTER)[' ']{0,}[;]{1}[' ']{0,}"),
